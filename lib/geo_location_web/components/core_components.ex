defmodule GeoLocationWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(GeoLocationWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(GeoLocationWeb.Gettext, "errors", msg, opts)
    end
  end
